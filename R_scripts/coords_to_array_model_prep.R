...
# Extract centre and remove others
coords_rotated$ID
spoke_1 <- c("0102", "0103", "0104", "0105")
spoke_2 <- c("0106", "0107", "0108", "0109")
spoke_3 <- c("0110", "0111", "0112", "0113")
spoke_4 <- c("0114", "0115", "0116", "0117")
spoke_5 <- c("0118", "0119", "0120", "0121")
spoke_6 <- c("0122", "0123", "0124", "0125")
spoke_7 <- c("0126", "0127", "0128", "0129")
spoke_8 <- c("0130", "0131", "0132", "0133")
...
# targets <- coords_rotated %>% dplyr::filter(., ID %in% centres)
...
#save(grid_coarse, file = file.path("./Rdata", "2023palau_coarse_grid_centre.RData"))
...
#random_centre
load("./Rdata/2023palau_coarse_grid_0096.RData") # grid_coarse
x0096 = grid_coarse 
load("./Rdata/2023palau_coarse_grid_0091.RData") # grid_coarse
x0091 = grid_coarse 
load("./Rdata/2023palau_coarse_grid_0099.RData") # grid_coarse
x0099 = grid_coarse 
load("./Rdata/2023palau_coarse_grid_0087.RData") # grid_coarse
x0087 = grid_coarse 
rand_center = list('x0096' = x0096, 'x0091' = x0091, 'x0099' = x0099,'x0087' = x0087)
#save(rand_center, file = file.path("./Rdata", "2023palau_rand_center_list.RData"))
load("./Rdata/2023palau_rand_center_list.RData") # grid_coarse
